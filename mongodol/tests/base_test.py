...
def test_basic_mongo_kvreader_functionality(mongo_reader_cls=MongoCollectionReader,):
    ...
    # test iter_projection=None input indeed eliminates field projection
    # See: https://github.com/i2mint/mongodol/discussions/5
    ...
    test_docs = [
        ...
        {'_id': '456', 'ref': 'absolute/reference/to/some/other/content',},
        {'_id': '789', 'optional': 'metadata',},
    ]

    s = get_test_collection_persister(iter_projection=None)
    for doc in s:
        del s[doc]
    for doc in test_docs:
        s[doc] = doc
    assert list(s) == test_docs
