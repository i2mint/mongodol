...
Bases: [`MongoCollectionPersister`](mongodol.base.md#mongodol.base.MongoCollectionPersister)
...
* **Raises:**
  [**KeyNotUniqueError**](mongodol.util.md#mongodol.util.KeyNotUniqueError) – if the k matches more than a single unique doc.
